...
func (x *AuditReviewReply) GetReplyID() int64 {
	if x != nil {
		return x.ReplyID
	}
	return 0
...
func (x *AuditAppealReply) GetReviewID() int64 {
	if x != nil {
		return x.ReviewID
	}
	return 0
...
const file_operation_v1_operation_proto_rawDesc = "" +
	...
	"\breviewID\x18\x01 \x01(\x03R\breviewID2\xf9\x01\n" +
	"\tOperation\x12u\n" +
	...
	"\x10api.operation.v1P\x01Z\x1creview-B/api/operation/v1;v1b\x06proto3"
