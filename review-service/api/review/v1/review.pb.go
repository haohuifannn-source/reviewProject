...
type ReplyReviewRequest struct {
	...
	PicInfo       string                 `protobuf:"bytes,4,opt,name=picInfo,proto3" json:"picInfo,omitempty"` //图片信息
...
const file_api_review_v1_review_proto_rawDesc = "" +
	...
	"\breviewID\x18\x01 \x01(\x03R\breviewID\"\xba\x01\n" +
	...
	"\areplyID\x18\x01 \x01(\x03R\areplyID\"\x15\n" +
	...
	"\x0fListReviewReply2\xa7\x04\n" +
	"\x06Review\x12k\n" +
	"\fCreateReview\x12\".api.review.v1.CreateReviewRequest\x1a .api.review.v1.CreateReviewReply\"\x15\x82\xd3\xe4\x93\x02\x0f:\x01*\"\n" +
	"/v1/review\x12g\n" +
	"\vReplyReview\x12!.api.review.v1.ReplyReviewRequest\x1a\x1f.api.review.v1.ReplyReviewReply\"\x14\x82\xd3\xe4\x93\x02\x0e:\x01*\"\t/v1/reply\x12T\n" +
...
var file_api_review_v1_review_proto_depIdxs = []int32{
	...
	4,  // 2: api.review.v1.Review.UpdateReview:input_type -> api.review.v1.UpdateReviewRequest
	6,  // 3: api.review.v1.Review.DeleteReview:input_type -> api.review.v1.DeleteReviewRequest
	8,  // 4: api.review.v1.Review.GetReview:input_type -> api.review.v1.GetReviewRequest
	10, // 5: api.review.v1.Review.ListReview:input_type -> api.review.v1.ListReviewRequest
	1,  // 6: api.review.v1.Review.CreateReview:output_type -> api.review.v1.CreateReviewReply
	3,  // 7: api.review.v1.Review.ReplyReview:output_type -> api.review.v1.ReplyReviewReply
	5,  // 8: api.review.v1.Review.UpdateReview:output_type -> api.review.v1.UpdateReviewReply
	7,  // 9: api.review.v1.Review.DeleteReview:output_type -> api.review.v1.DeleteReviewReply
	9,  // 10: api.review.v1.Review.GetReview:output_type -> api.review.v1.GetReviewReply
	11, // 11: api.review.v1.Review.ListReview:output_type -> api.review.v1.ListReviewReply
