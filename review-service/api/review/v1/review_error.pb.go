...
const (
	...
	ErrorReason_DB_FILED       ErrorReason = 1
	ErrorReason_OVDER_REVIEWED ErrorReason = 100
	ErrorReason_OVDER_REPLYED  ErrorReason = 101
)
...
const file_api_review_v1_review_error_proto_rawDesc = "" +
	"\n" +
	" api/review/v1/review_error.proto\x12\rapi.kratos.v1\x1a\x13errors/errors.proto*p\n" +
	"\vErrorReason\x12\x14\n" +
	"\n" +
	"NEED_LOGIN\x10\x00\x1a\x04\xa8E\x91\x03\x12\x12\n" +
	"\bDB_FILED\x10\x01\x1a\x04\xa8E\xf4\x03\x12\x18\n" +
	"\x0eOVDER_REVIEWED\x10d\x1a\x04\xa8E\x90\x03\x12\x17\n" +
	"\rOVDER_REPLYED\x10e\x1a\x04\xa8E\x92\x03\x1a\x04\xa0E\xf4\x03B2\n" +
