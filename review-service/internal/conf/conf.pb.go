...
type Bootstrap struct {
	...
	Snowflake     *Sonwflake             `protobuf:"bytes,3,opt,name=snowflake,proto3" json:"snowflake,omitempty"`
...
func (x *Bootstrap) GetSnowflake() *Sonwflake {
	if x != nil {
		return x.Snowflake
	}
	return nil
...
func (x *Sonwflake) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Sonwflake) ProtoMessage() {}

func (x *Sonwflake) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Sonwflake.ProtoReflect.Descriptor instead.
func (*Sonwflake) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{3}
}

func (x *Sonwflake) GetStartTime() string {
	if x != nil {
		return x.StartTime
	}
	return ""
...
func (x *Sonwflake) GetMachineId() int64 {
	if x != nil {
		return x.MachineId
	}
	return 0
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\tsnowflake\x18\x03 \x01(\v2\x15.kratos.api.SonwflakeR\tsnowflake\x12?\n" +
	...
	"\x05index\x18\x02 \x01(\tR\x05indexB#Z!review-service/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Sonwflake)(nil),           // 3: kratos.api.Sonwflake
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	3,  // 2: kratos.api.Bootstrap.snowflake:type_name -> kratos.api.Sonwflake
